      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            _buildNavItem(Icons.card_travel, 3),
  ...
  Widget _buildNavItem(IconData icon, int index) {
    return Material(
      ...
      child: InkWell(
        ...
        splashColor: Colors.red.withOpacity(0.3), // Splash effect color
        borderRadius: BorderRadius.circular(30), // Ripple follows this shape
